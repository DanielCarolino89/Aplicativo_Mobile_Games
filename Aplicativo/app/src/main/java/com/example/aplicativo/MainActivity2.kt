...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnUm.setOnClickListener {
            btnUm.setBackgroundColor(ContextCompat.getColor(this, R.color.Certo))
            textoPergunta.text = "PARABÉNS VOCÊ ECONOMIZOU!"
            btnDois.isEnabled = false
        }

        btnDois.setOnClickListener {
            btnDois.setBackgroundColor(ContextCompat.getColor(this, R.color.Errado))
        ...
        btnContinuar.setOnClickListener {
            ...
            val valorSomado: Int = if (btnUm.isEnabled) 1 else 0
